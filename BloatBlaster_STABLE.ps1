...
function installApps 
{
    ...
    $OptionalSoftware = @(
        ...
        @{ Name = "Webex"; Id = "OpenVPNTechnologies.OpenVPNConnect" },
        @{ Name = "Webex"; Id = "Dropbox.Dropbox" },
        @{ Name = "Webex"; Id = "Spotify.Spotify" },
        @{ Name = "Webex"; Id = "WiresharkFoundation.Wireshark" },
        @{ Name = "Webex"; Id = "PuTTY.PuTTY" },
        @{ Name = "Webex"; Id = "RevoUninstaller.RevoUninstaller" },
